...
func InitRoutes() *mux.Router {
	...
	router.HandleFunc("/stack/questions/{classification}/{details}/{sorting}", controllers.WrapHandler(controllers.GetStackQuestionsByClassificationDetailsAndSorting))
